<script lang="ts">
  ...
  import { INPUT_LIMITS, sanitizeGeneratorSymbols } from "../../lib/input-validation";
...
<section class="drawer-section">
  ...
  <label class="text-control">
    <span>允许使用的符号</span>
    <ClearableInput value={allowedSymbols} clearable={false} fallbackValue="!@#$%^&*+-_=?." maxlength={INPUT_LIMITS.generatorCharacters} disabled={!useSymbols} transformValue={sanitizeGeneratorSymbols} onValueChange={setAllowedSymbols} />
  </label>
</section>
